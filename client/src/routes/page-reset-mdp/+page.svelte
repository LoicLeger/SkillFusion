...
<div class="reset-password-container">
	...
	<form class="reset-password-form" onsubmit={handleSubmit}>
		...
		<div class="form-group">
			<input type="password" bind:value={password} placeholder="Nouveau mot de passe" required />
		</div>
		<div class="form-group">
			<input
				type="password"
		...
		<div class="form-group">
			<button type="submit" class="btn-reset-password"> Réinitialiser le mot de passe </button>
		</div>
	</form>
</div>
