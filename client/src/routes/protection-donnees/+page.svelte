...
<main class="protection-donnees">
	...
	<p>
		...
		- L'exécution du contrat (CGU)<br />
		- Votre consentement<br />
		- Notre intérêt légitime<br />
		- Le respect d'obligations légales
	</p>

	<h2>5. Destinataires des données</h2>
	<p>
		Vos données sont accessibles uniquement au personnel autorisé de SkillFusion et à nos
		sous-traitants (hébergeur, service de paiement si applicable).
	</p>

	<h2>6. Durée de conservation</h2>
	<p>
		Les données sont conservées pendant la durée nécessaire à la fourniture des services, plus 3 ans
		après la fermeture du compte pour des raisons légales.
	</p>

	<h2>7. Sécurité des données</h2>
	<p>
		Nous mettons en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos
		données contre la perte, l'altération ou l'accès non autorisé.
	</p>

	<h2>8. Cookies</h2>
	<p>
		Le site utilise des cookies pour améliorer votre expérience. Vous pouvez gérer vos préférences
	...
	<p>
		Si vous estimez que vos droits ne sont pas respectés, vous pouvez saisir la CNIL (<a
