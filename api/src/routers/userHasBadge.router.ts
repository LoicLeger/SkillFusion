...
router.post("/userHasBadge", verifyToken, checkRoles([ROLES.ADMIN]), userHasBadgeController.assigneBadge)

router.delete("/userHasBadge/:id", verifyToken, checkRoles([ROLES.ADMIN]), userHasBadgeController.deleteBadge)
