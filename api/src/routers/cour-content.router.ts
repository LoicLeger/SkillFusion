...
// Routes public
router.get("/cours-contents",checkRoles([ROLES.STUDENT,ROLES.INSTRUCTOR, ROLES.ADMIN]), courContent.getAll)
router.get("/cours-contents/:id",checkRoles([ROLES.STUDENT,ROLES.INSTRUCTOR, ROLES.ADMIN]), courContent.getOneCourContent)
