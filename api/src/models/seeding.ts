    ...
    const courses = await prisma.cours.createMany({
        data: [
            // Menuiserie (5 cours)
            {
                ...
                littleSummary:
                    'Apprenez à fixer une étagère droite, stable et adaptée à votre mur.',
                summary:
            ...
            // Plomberie (5 cours)
            {
                ...
                littleSummary:
                    "Remplacez un siphon en évitant les fuites et en respectant l'écoulement.",
                summary:
            ...
            // Chauffage (5 cours)
            {
                ...
                littleSummary:
                    'Nettoyez vos radiateurs pour améliorer la chaleur et réduire le bruit.',
                summary:
            ...
            // Carrelage (5 cours)
            {
                ...
                littleSummary:
                    'Posez une faïence propre et régulière dans votre salle de bain ou cuisine.',
                summary:
